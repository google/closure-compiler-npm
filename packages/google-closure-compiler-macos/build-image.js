...
if (fs.existsSync(path.resolve(__dirname, 'compiler'))) {
  process.stdout.write(dimWhite(`  google-closure-compiler-macos binary already exists\n`));
} else if (process.platform !== 'darwin') {
  process.stdout.write(dimWhite(`  google-closure-compiler-macos build wrong platform\n`));
} else {
  process.stdout.write(dimWhite(`  google-closure-compiler-macos building image\n`));
